...
public class BarChart01View extends GraphicalView implements Runnable{
	...
	private void chartRender()
	{
		try {								
			...
			//轴颜色
			int axisColor = Color.rgb(0, 0, 0); // Color.rgb(222, 136, 166);
...
//		chartData.add(BarDataA);
    ...
    public void charDataadd(BarData data)
    {
        chartData.add(data);
    }
	...
	private void chartLabels()
	{
        ...
        chartLabels.add("Used");
        chartLabels.add("Free");
        chartLabels.add("Shared");
        chartLabels.add("Buffers");
        chartLabels.add("Cached");
	}	
